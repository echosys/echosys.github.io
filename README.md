...
Python: Selenium, PyDev, PyCharm, Pyautogui, virtualenv, Django, Anaconda, Scipy   
Javascript: D3.js, React.js, Node.js    
Tools: AWS EC2, Android Studio, Tableau  
SQL: SQLite, MySQL, PostgreSQL  
General: Linux Shell, GIT  


### Experiences
#### Intern Software Engineer, General Motors, Phoenix, AZ     [May-Aug 18, 3mo]
...
#### Intern Software Developer, Edupoint Educational Systems, Mesa, AZ	[Jan-Aug 17, 6mo]
...
#### Intern Software Engineer, NXP Semiconductor, Chandler, AZ	[Jun-Sep 16, 3mo]  
...
#### Intern Software Engineer, Freescale Semiconductor, Tempe, AZ	[Jun-Nov15, 6mo]  
...
<div style="text-align: right"> William Ge</div>

### Resume
[General Resume](http://echosys.github.io/pdf/Resume_William_Ge.pdf)

### Contact
firstname+lastname+9[at]geemale[ddot]come
